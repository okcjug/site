...
== Lunch Meeting (link:/index.php?option=com_attend_events&task=view&id=14[register here]) +

When: May 13, 2008 11:30-12:40

Where: University of Phoenix room *308 * (see
link:/component/option,%20%3Ca%20href=[buy] com_google_maps/Itemid,31/"
title="Meeting location">Meeting location or
http://tinyurl.com/6xz439[here] )

* Topic: link:content/view/71/1/[Persistence in Java with Hibernate and
JPA]

Speaker: link:content/view/70/34/[Michael E. Shorter]
...
== Evening Meeting (link:/index.php?option=com_attend_events&task=view&id=15[register here]) +
