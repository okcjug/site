...
* Speaker: link:/bios/jason_lee[Jason Lee]
...
http://jcp.org/en/jsr/detail?id=311[JAX-RS specification]. We'll cover
...
look at the https://jersey.dev.java.net/[Jersey] Client, and how that
